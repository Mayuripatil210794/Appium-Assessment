...
driver.findElement(By.id("com.androidsample.generalstore:id/nameField")).sendKeys("Rani Doshi");
Thread.sleep(2000);
...
Files.copy(f, new File("C:\\MayuriPatil_Appium\\screenshot\\general screenshot"));
Thread.sleep(2000);
